const en = {
  ...
  "review.gated": "You can review this product after your order is delivered.",
  ...
  "create.path.sub": "Pick what you're starting from — all three paths are live.",
  "create.path.photo.title": "From a photo",
  "create.path.photo.desc": "Turn a photo of a person, pet or object into 3D — you pick the design template.",
  "create.path.design.title": "2D Design → Product",
  "create.path.design.desc": "A custom 3D product from a logo, drawing or flat image.",
  "create.path.upload.title": "My Own 3D File",
  "create.path.upload.desc": "Already have a 3D model (STL/OBJ)? Print it here. Otherwise use From a photo.",
  ...
  "hero.create.beforeAlt": "Uploaded photo",
  "hero.create.afterAlt": "3D printed figurine",
  ...
  "store.promo.custom.title": "Make your own",
  "store.promo.custom.sub": "Photo to figurine, object to product — your idea, printed.",
  "store.promo.custom.cta": "Start creating",
  "store.custom.title": "Can't find what you're looking for?",
  "store.custom.sub": "We'll make it for you — from a photo, your own 3D model, or a 2D design.",
  "store.custom.cta": "Start a custom order",
  "store.custom.cta2": "How it works",
  "network.eyebrow": "Production network in {n} provinces",
  "network.title": "Türkiye's widest 3D production network",
  "network.sub": "Your order goes to the workshop nearest you. Tap a province to see how many workshops are there and which ones serve it.",
  "network.stat.covered": "Serving {n} provinces",
  "network.stat.home": "Workshops in {n} cities",
  "network.stat.shipping": "Free shipping anywhere in Türkiye",
  "network.mapLabel": "Türkiye production network map, provinces with partners",
  "network.provinceAria": "{il}: {located} workshops, {covering} partners serving",
  "network.tooltip.located": "{n} workshops",
  "network.tooltip.covering": "{n} partners serving",
  "network.selectLabel": "Choose a province",
  "network.selectPlaceholder": "Choose a province…",
  "network.kind.manufacturer": "Manufacturing workshop",
  "network.kind.painter": "Painting workshop",
  "network.legend.covered": "Province served",
  "network.hint": "Tap a province for details.",
  "network.clear": "Clear",
  "network.group.located": "Workshops in this province",
  "network.group.serving": "Serving this province",
  "network.empty.located": "No workshop in this province yet.",
  "network.empty.serving": "No partner serves it from another province.",
  "network.provinceCount": "{n} prov.",
  "network.back": "← Back",
  "network.coverageTitle": "Provinces served ({n})",
  "network.material.resin": "Resin",
  "network.material.filament": "Filament",
  "store.search.resultsFor": "results for",
  "cart.title": "Cart",
  ...
  "upload.processing": "Processing your model… checking the geometry.",
  "upload.resultTitle": "Your model is ready",
  "upload.price": "Estimated price",
  "upload.needsQuote": "We'll prepare a custom quote for this model.",
  "upload.needsQuoteSub": "This model wasn't suitable for automatic pricing (not a single closed piece, or larger than our print size). Our team will review it and quote you.",
  "upload.risk.thin_walls": "Thin walls",
  "upload.risk.not_watertight": "Model isn't closed",
  "upload.risk.dropped_significant_component": "Loose parts removed",
  "upload.requestCta": "Submit print request",
  "upload.placeOrder": "Place order",
  "upload.emailPlaceholder": "Your email",
  "quote.title": "Your print quote",
  "quote.price": "Quoted price",
  "quote.pending": "Your quote is being prepared — we'll get back to you shortly.",
  "upload.requestDoneTitle": "Request received",
  "upload.requestDoneSub": "We'll confirm the price and send you a payment link.",
  "upload.another": "Upload another model",
  "upload.note": "STL or OBJ. The model should be a single closed piece and fit within ~22×22×25 cm.",
  "upload.errGeneric": "Something went wrong. Please try again.",
  "shop.subtitle": "Discover ready-made prints from our makers.",
  "shop.empty": "No products yet.",
  "shop.filter.all": "All",
  "shop.buy": "Buy",
  "shop.leadTime": "Ships in",
  "shop.days": "days",
  "shop.backToShop": "Back to shop",
  "shop.checkout.title": "Delivery & Payment",
  "shop.checkout.name": "Full name",
  "shop.checkout.email": "Email",
  "shop.checkout.address": "Address",
  "shop.checkout.province": "Province",
  "shop.checkout.district": "District",
  "shop.checkout.neighborhood": "Neighborhood",
  "shop.checkout.postalCode": "Postal code",
  "shop.checkout.pay": "Pay",
  "shop.checkout.processing": "Processing…",
  "shop.checkout.failed": "Could not create order",
  "shop.checkout.guestRequired": "Name and email are required",
  "product.detail.soldBy": "Sold by",
  "product.category.figurine": "Figurine",
  "product.category.home_decor": "Home Decor",
  "product.category.toy": "Toy",
  "product.category.jewelry": "Jewelry",
  "product.category.gadget": "Gadget",
  "product.category.other": "Other",
  "home.featured.title": "From the Shop",
  "home.featured.viewAll": "View all",

  // Landing — Marketplace reposition (dual-path home)
  "landing.market.hero.eyebrow": "3D Marketplace + Production Studio",
  "landing.market.hero.titleLead": "Browse, buy,",
  "landing.market.hero.titleAccent": "create.",
  "landing.market.hero.sub": "Discover ready-made 3D prints from our makers — or have us produce a figurine from your photo, a product from an object, even a print from your own model.",
  "landing.market.path.shop.kicker": "Marketplace",
  "landing.market.path.shop.title": "Shop ready-made 3D prints",
  "landing.market.path.shop.desc": "Figurines, decor, toys and more — printed and shipped by our maker network.",
  "landing.market.path.shop.cta": "Browse the marketplace",
  "landing.market.path.custom.kicker": "Custom Production",
  "landing.market.path.custom.title": "Make something of your own",
  "landing.market.path.custom.desc": "Photo to figurine, object to product, or your own 3D model to print. Made to order, for you.",
  "landing.market.path.custom.cta": "Start creating",
  "landing.market.cats.eyebrow": "Marketplace",
  "landing.market.cats.title": "Browse by category",
  "landing.market.cats.sub": "Curated 3D-printed pieces across every shelf.",
  "landing.market.cats.all": "See everything",
  "landing.market.produce.eyebrow": "Production",
  "landing.market.produce.title": "What we can make for you",
  "landing.market.produce.sub": "From a single photo to your own 3D model — printed in resin or filament.",
  "landing.market.produce.soon": "Soon",
  "landing.market.produce.figure.title": "Photo to Figurine",
  "landing.market.produce.figure.desc": "Turn a photo into an adorable, hand-finished 3D figurine.",
  "landing.market.produce.object.title": "Object to Product",
  "landing.market.produce.object.desc": "Photograph any object and we will print it in 3D.",
  "landing.market.produce.upload.title": "Your Own Model",
  "landing.market.produce.upload.desc": "Upload an STL/OBJ and print it in resin or filament.",
  "landing.market.produce.design.title": "2D Design to Product",
  "landing.market.produce.design.desc": "A custom 3D product from your logo or artwork.",
  "landing.market.cta.title": "Ready when you are.",
  "landing.market.cta.sub": "Explore the marketplace, or make something custom.",
  "landing.market.cta.shop": "Browse marketplace",
  "landing.market.cta.custom": "Create custom",
  "payment.card": "Card",
  "payment.bankTransfer": "Bank transfer",
  "manufacturer.nav.products": "My Products",
  "admin.nav.products": "Products",
  "manufacturer.orderDetail.marketplaceBadge": "Marketplace product",
  "manufacturer.orderDetail.marketplaceHint": "Print your listed product and ship it.",

  // ─── Seller (manufacturer) product management ────────────────
  "manufacturer.nav.panel": "Manufacturer Panel",
  "manufacturer.orderDetail.acceptDescription": "Review the order details and accept to begin manufacturing.",
  "manufacturer.orderDetail.acceptOrder": "Accept Order",
  "manufacturer.orderDetail.assignedDate": "Assigned",
  "manufacturer.orderDetail.copied": "Copied",
  "manufacturer.orderDetail.copy": "Copy",
  "manufacturer.orderDetail.markPrinted": "Mark as Printed",
  "manufacturer.orderDetail.modifiers": "Modifiers",
  "manufacturer.orderDetail.newOrderAssigned": "New Order Assigned",
  "manufacturer.orderDetail.noActions": "No actions available.",
  "manufacturer.orderDetail.noHistory": "No actions yet.",
  "manufacturer.orderDetail.orderInfo": "Order Info",
  "manufacturer.orderDetail.orderNumber": "Order Number",
  "manufacturer.orderDetail.orderShipped": "Order Shipped!",
  "manufacturer.orderDetail.orders": "Orders",
  "manufacturer.orderDetail.printDescription": "Start the 3D printing process for this figurine.",
  "manufacturer.orderDetail.printedDescription": "Mark as printed once the figurine is complete.",
  "manufacturer.orderDetail.printingInProgress": "Printing in Progress",
  "manufacturer.orderDetail.processing": "Processing...",
  "manufacturer.orderDetail.readyToPrint": "Ready to Print",
  "manufacturer.orderDetail.readyToShip": "Ready to Ship",
  "manufacturer.orderDetail.shipDescription": "Enter the tracking number and ship to customer.",
  "manufacturer.orderDetail.shipOrder": "Ship Order",
  "manufacturer.orderDetail.style": "Style",
  "manufacturer.orderDetail.trackingLabel": "Tracking",
  "manufacturer.orders.all": "All",
  "manufacturer.orders.next": "Next",
  "manufacturer.orders.prev": "Previous",
  "manufacturer.orders.showingRange": "Showing {start} to {end} of {total}",
  "manufacturer.orders.table.assigned": "Assigned",
  "manufacturer.orders.table.customer": "Customer",
  "manufacturer.orders.table.order": "Order",
  ...
  "manufacturer.products.editTitle": "Edit product",
  "manufacturer.products.archive": "Archive",
  "manufacturer.products.submit": "Submit for review",
  "manufacturer.products.imagesShort": "images",
  "manufacturer.products.table.product": "Product",
  "manufacturer.products.table.price": "Price",
  "manufacturer.products.table.status": "Status",
  "product.create": "Create & continue",
  "product.saved": "Changes saved.",
  "product.submit.title": "Submit for review",
  "product.rejected.title": "Product rejected",
  ...
  "product.field.leadTime": "Lead time (days)",
  "product.material.resin": "Resin",
  "product.material.filament": "Filament (FDM)",
  "product.material.none": "Not specified",
  ...
  "admin.products.subtitle": "Approve seller products and create platform products.",
  "admin.products.pendingTitle": "Awaiting approval",
  "admin.products.pendingEmpty": "No products awaiting approval.",
  "admin.products.allTitle": "All products",
  "admin.products.allEmpty": "No products yet.",
  "admin.products.approve": "Approve",
  "admin.products.reject": "Reject",
  "admin.products.reasonPlaceholder": "Rejection reason...",
  "admin.products.reasonRequired": "Enter a rejection reason.",
  "admin.products.rejectionReason": "Rejection reason",
  "admin.products.confirmReject": "Reject this product?",
  "admin.products.confirmArchive": "Are you sure you want to archive this product?",
  "admin.products.archive": "Archive",
  "admin.products.edit": "Edit",
  "admin.products.addPlatformProduct": "Add platform product",
  "admin.products.createCta": "Create & add images",
  "admin.products.newTitle": "Create platform product",
  "admin.products.newSubtitle": "The created product goes live immediately. You can add images afterwards.",
  "admin.products.editTitle": "Edit product",
  "admin.products.backToList": "Back to products",
  "admin.products.colOwner": "Owner",
  "admin.products.colSeller": "Seller",
  ...
  "admin.products.ownerSeller": "Seller",
  "admin.products.fieldTitle": "Title",
  "admin.products.fieldDescription": "Description",
  "admin.products.fieldPrice": "Price (₺)",
  "admin.products.fieldMaterial": "Material",
  "admin.products.fieldCategory": "Category",
  "admin.products.fieldLeadTime": "Lead time (days)",
  "admin.products.optionNone": "—",
  "admin.products.imagesTitle": "Images",
  "admin.products.noImage": "No image",
  "admin.products.noImages": "No images yet.",
  "admin.products.deleteImage": "Delete image",
  "admin.products.deleteImageFailed": "Could not delete image.",
  "admin.products.uploadFailed": "Could not upload image.",
  "admin.products.uploading": "Uploading...",
  "admin.products.save": "Save",
  "admin.products.saveFailed": "Could not save.",
  "admin.products.savedNotice": "Saved.",
  "admin.products.cancel": "Cancel",
  "admin.products.createFailed": "Could not create product.",
  "admin.products.priceInvalid": "Enter a valid price.",
  "nav.account": "Account",
  "nav.login": "Log In",
  "nav.logout": "Log Out",
  ...
  "register.marketingConsent": "I'd like to receive campaigns, news and offers by email/SMS.",
  "register.marketingConsentLink": "Commercial message terms",
  ...
  "upsell.digital_files.label": "Digital files (STL + OBJ)",
  "upsell.digital_files.description": "Download the print-ready 3D files of your design from your order page.",
  ...
  "create.title.object": "Turn Your Object into a Product",
  ...
  "validator.product.title.required": "Title must be at least 3 characters",
  "validator.product.title.tooLong": "Title is too long",
  "validator.product.description.required": "Description must be at least 10 characters",
  "validator.product.description.tooLong": "Description is too long",
  "validator.product.price.invalid": "Enter a valid price",
  "validator.product.price.tooLow": "Price is too low",
  "validator.product.price.tooHigh": "Price is too high",
  "validator.product.id.invalid": "Invalid product",
  ...
  "api.order.quoteOnly": "This item is priced by hand. Please request a quote on WhatsApp.",
  "api.order.productUnavailable": "This product is no longer available",
  ...
  "account.gallery.publishFailed": "Failed to publish. Please try again.",
  ...
  "track.digitalFiles.title": "Digital files",
  "track.digitalFiles.preparing": "Your print-ready files are being prepared. They'll be downloadable here once production completes.",
  ...
  "manufacturer.register.passwordMismatch": "Passwords do not match",
  ...
  "landing.fig.ticker": "Made in Türkiye · Free shipping in Türkiye · PayTR 3D Secure · Preview before we print · Made to order · Resin & filament ·",
  ...
  "landing.fig.styles.storybook": "Storybook",
  ...
  "landing.fig.footer.tagline": "Handmade in Türkiye · free shipping across Turkey",
  ...
  "landing.fig.footer.nav.figure": "Custom figurine",
  "landing.fig.footer.nav.howItWorks": "How it works",
  "landing.fig.footer.nav.shop": "Shop",
  "landing.fig.footer.nav.products": "Ready-made products",
  "landing.fig.footer.nav.bulk": "Bulk orders",
  "landing.fig.footer.nav.create": "Create yours",
  ...
  "landing.fig.footer.legal.shipping": "Shipping & Delivery",
  "landing.fig.footer.legal.cookies": "Cookie Policy",
  "landing.fig.footer.legal.privacy": "Privacy",
  "landing.fig.footer.legal.terms": "Terms",
  "landing.fig.footer.legal.commercial": "Commercial Messages",
  ...
  "tracker.quality_check.label": "Quality Check",
  "tracker.quality_check.description": "We're inspecting your figurine before it ships.",
  "manufacturer.status.qc_pending": "Quality Check",
  "manufacturer.status.qc_rejected": "QC Rejected",
  "manufacturer.status.qc_approved": "QC Approved",
  "manufacturer.action.submit_qc": "Submitted QC photos",
  "manufacturer.orderDetail.qcTitle": "Quality Control Photos",
  "manufacturer.orderDetail.qcDescription":
    "Upload clear photos of the finished print. An admin reviews them before you can ship.",
  "manufacturer.orderDetail.qcUpload": "Add photos",
  "manufacturer.orderDetail.qcSubmit": "Submit for review",
  "manufacturer.orderDetail.qcSubmitting": "Submitting…",
  "manufacturer.orderDetail.qcMaxPhotos": "Up to 6 photos",
  "manufacturer.orderDetail.qcRemove": "Remove",
  "manufacturer.orderDetail.qcNeedPhoto": "Add at least one photo before submitting.",
  "manufacturer.orderDetail.qcUploadFailed": "Photo upload failed",
  "manufacturer.orderDetail.qcPendingTitle": "Awaiting Quality Check",
  "manufacturer.orderDetail.qcPendingDescription":
    "Your photos are with the admin for review. You'll be notified once approved.",
  "manufacturer.orderDetail.qcPhotosSubmitted": "Submitted photos",
  "manufacturer.orderDetail.qcRejectedTitle": "Quality Check Rejected",
  "manufacturer.orderDetail.qcRejectedReason": "Reason",
  "manufacturer.orderDetail.qcRejectedDescription":
    "Please fix the issue, upload new photos, and resubmit.",
  "manufacturer.orderDetail.chatTitle": "Chat with admin",
  "manufacturer.orderDetail.customerNote": "Customer note",
  "admin.qc.title": "Quality Control Review",
  "admin.qc.description": "Review the manufacturer's finished-product photos.",
  "admin.qc.approve": "Approve",
  "admin.qc.reject": "Reject",
  "admin.qc.rejectReason": "Rejection reason (shown to manufacturer)",
  "admin.qc.rejectReasonRequired": "A reason is required to reject.",
  "admin.qc.round": "Round",
  "admin.qc.noPhotos": "No QC photos submitted yet.",
  "admin.qc.history": "Review history",
  "admin.qc.approved": "Approved",
  "admin.qc.rejected": "Rejected",
  "admin.qc.processing": "Processing…",
  "admin.nav.qcQueue": "QC Queue",
  "admin.qcQueue.title": "Quality Control Queue",
  "admin.qcQueue.empty": "No orders awaiting quality check.",
  "admin.qcQueue.photos": "photos",
  "admin.qcQueue.submitted": "Submitted",
  "admin.qcQueue.view": "Review",
  "admin.dashboard.qcPending": "Awaiting QC",
  "admin.chat.title": "Order conversations",
  "admin.chat.customerTab": "Customer",
  "admin.chat.manufacturerTab": "Manufacturer",
  "admin.chat.noManufacturer": "No manufacturer assigned yet.",
  "email.qcSubmitted.subject": "QC photos submitted — {orderNumber}",
  "email.qcSubmitted.heading": "Quality check photos submitted",
  "email.qcSubmitted.body":
    "{companyName} submitted finished-product photos for order {orderNumber}. Review them in the QC queue.",
  "email.newMessage.subject": "New message about your order {orderNumber}",
  ...
  "track.note.placeholder":
    "e.g. paint the base blue; it's a gift — no invoice in the box",
  "track.note.save": "Save note",
  "track.note.saved": "Saved",
  "track.note.saving": "Saving…",
  "track.note.locked": "Notes can't be changed after the order ships.",

  // ─── Faz 2: earnings / payouts / invoice / cancel ─────────────
  "manufacturer.nav.earnings": "Earnings",
  "manufacturer.earnings.title": "Earnings & Payouts",
  "manufacturer.earnings.owed": "Awaiting payout",
  "manufacturer.earnings.paidTotal": "Paid to date",
  "manufacturer.earnings.perOrder": "Per-order earnings",
  "manufacturer.earnings.net": "Net",
  "manufacturer.earnings.gross": "Gross",
  "manufacturer.earnings.commission": "Commission",
  "manufacturer.earnings.status.pending": "Pending",
  "manufacturer.earnings.status.paid": "Paid",
  "manufacturer.earnings.status.reversed": "Reversed",
  "manufacturer.earnings.empty": "No earnings yet.",
  "manufacturer.earnings.payouts": "Payout history",
  "manufacturer.orderDetail.cancelLink": "Can't fulfill — cancel order",
  "manufacturer.orderDetail.cancelConfirm":
    "Cancel this accepted order? It returns to the admin queue and counts as a strike.",
  "manufacturer.orderDetail.cancelReason": "Reason (optional)",
  "manufacturer.orderDetail.cancel": "Cancel order",
  "track.invoice.button": "View invoice (KDV)",
  "track.invoice.title": "Invoice",
  "track.invoice.number": "Invoice no",
  "track.invoice.subtotal": "Subtotal",
  "track.invoice.kdv": "KDV",
  "track.invoice.total": "Total",

  // ─── Faz 3: carrier / dispute / KYC / IBAN ────────────────────
  "manufacturer.orderDetail.carrier": "Carrier",
  ...
  "carrier.other": "Other",
  "tracker.trackShipment": "Track shipment",
  "track.dispute.button": "Report a problem",
  "track.dispute.title": "Report a problem",
  "track.dispute.category": "Issue",
  "track.dispute.cat.not_as_described": "Doesn't match my photo",
  "track.dispute.cat.damaged": "Arrived damaged",
  "track.dispute.cat.not_received": "Never arrived",
  "track.dispute.cat.other": "Other",
  "track.dispute.description": "Describe the problem",
  "track.dispute.submit": "Submit",
  "track.dispute.open": "Your report is open — we're looking into it.",
  "track.dispute.resolved": "Resolved",
  "track.dispute.rejected": "Reviewed — no action",
  "track.dispute.status": "Status",
  "manufacturer.profile.kyc.title": "Verification documents",
  "manufacturer.profile.kyc.desc": "Upload your tax certificate and registry documents for verification.",
  "manufacturer.profile.kyc.type": "Document type",
  "manufacturer.profile.kyc.upload": "Upload document",
  "manufacturer.profile.kyc.uploading": "Uploading…",
  "manufacturer.profile.kyc.type.vergi_levhasi": "Tax certificate",
  "manufacturer.profile.kyc.type.ticaret_sicil": "Trade registry",
  "manufacturer.profile.kyc.type.imza_sirkuleri": "Signature circular",
  "manufacturer.profile.kyc.type.kimlik": "ID",
  "manufacturer.profile.kyc.type.other": "Other",
  "manufacturer.profile.kyc.status.pending": "Under review",
  "manufacturer.profile.kyc.status.approved": "Approved",
  "manufacturer.profile.kyc.status.rejected": "Rejected",
  "manufacturer.profile.kyc.empty": "No documents uploaded yet.",
  "manufacturer.profile.iban.title": "Bank account (IBAN)",
  "manufacturer.profile.iban.change": "Request IBAN change",
  "manufacturer.profile.iban.pending": "IBAN change pending admin approval",
  "manufacturer.profile.iban.save": "Submit for approval",
  "manufacturer.profile.iban.placeholder": "TR…",

  // ─── Faz 4: notification center ───────────────────────────────
