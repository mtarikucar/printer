...
export async function GET(
  ...
  try {
    ...
    return handleRouteFailure(e, "GET /api/admin/products/[id]", ADMIN_READ_FAILED_ERROR);
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({ error: "Ürün güncellenemedi. Ürünün son durumunu görmek için sayfayı yenileyin; sorun sürerse sunucu günlüklerine bakın." }, { status: 500 });
    }
  } catch (e) {
    return handleRouteFailure(e, "PATCH /api/admin/products/[id]", ADMIN_ACTION_FAILED_ERROR);
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleRouteFailure(e, "DELETE /api/admin/products/[id]", ADMIN_ACTION_FAILED_ERROR);
  }
}
