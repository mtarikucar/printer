  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.paymentMethod === "bank_transfer") {
        // Go to track page with bank-transfer instructions
        router.push(`/track/${data.orderNumber}?payment=bank_transfer`);
        return;
      }

      // Fallback (legacy WhatsApp shape) — shouldn't happen with new flow
      if (data.whatsappUrl) {
