...
export async function POST(
  ...
  try {
    ...
    return handleRouteFailure(e, "POST /api/admin/products/[id]/images", ADMIN_ACTION_FAILED_ERROR);
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleRouteFailure(e, "DELETE /api/admin/products/[id]/images", ADMIN_ACTION_FAILED_ERROR);
  }
}
