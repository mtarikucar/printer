...
export async function GET() {
  try {
    ...
    return handleRouteFailure(e, "GET /api/manufacturer/documents", PARTNER_READ_FAILED_ERROR);
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleRouteFailure(e, "POST /api/manufacturer/documents", PARTNER_ACTION_FAILED_ERROR);
  }
}
