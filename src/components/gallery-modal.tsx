...
export function GalleryModal({
  ...
  return (
    ...
    >
      <div className="relative card shadow-elevated max-w-2xl w-full mx-4 overflow-hidden max-h-[90vh] flex flex-col animate-scale-in">
        {/* Close button */}
        <button
          onClick={onClose}
