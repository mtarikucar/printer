...
export async function GET(
  ...
  try {
    ...
    return handleRouteFailure(e, "GET /api/manufacturer/products/[id]", PARTNER_READ_FAILED_ERROR);
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({ error: "Ürün güncellenemedi. Ürünün son durumunu görmek için sayfayı yenileyin; sorun sürerse yöneticiye bildirin." }, { status: 500 });
    }
  } catch (e) {
    return handleRouteFailure(e, "PATCH /api/manufacturer/products/[id]", PARTNER_ACTION_FAILED_ERROR);
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleRouteFailure(e, "DELETE /api/manufacturer/products/[id]", PARTNER_ACTION_FAILED_ERROR);
  }
}
