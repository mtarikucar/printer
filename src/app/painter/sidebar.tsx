...
export function PainterSidebar({
  ...
  const links = [
    {
      ...
      icon: (
        <path
          ...
          strokeWidth={1.5}
          d="M4 6a2 2 0 012-2h4v6H4V6zm0 8h6v6H6a2 2 0 01-2-2v-4zm10 6v-6h6v4a2 2 0 01-2 2h-4zm0-16h4a2 2 0 012 2v4h-6V4z"
        />
      ),
      badge: 0,
    },
  ...
  const handleLogout = async () => {
    setLoggingOut(true);
    try {
      await fetch("/api/painter/auth/logout", { method: "POST" });
      ...
      window.location.assign("/painter/login");
    } catch {
      setLoggingOut(false);
    }
  };
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      <div className="p-6 border-b border-gray-200">
        ...
        <p className="text-xs text-indigo-600 mt-1">Boyama Paneli</p>
      </div>
