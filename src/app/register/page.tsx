              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder={d["register.placeholder.fullName"]}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-text-secondary mb-1.5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="input-base"
                    placeholder={d["register.placeholder.phone"]}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-text-secondary mb-1.5">
                  ...
                  <input
                    ...
                    className="input-base"
                    placeholder={d["register.placeholder.password"]}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-text-secondary mb-1.5">
                    {d["register.passwordConfirm"]}
                  </label>
                  <input
                    type="password"
                    required
