...
const tr: Dictionary = {
  ...
  "upload.sub": "STL veya OBJ dosyanı yükle; baskıya hazırlayıp fiyatlandıralım.",
  ...
  "upload.needsQuoteSub": "Geometri otomatik fiyatlandırmaya uygun değil (kapalı hacim değil ya da baskı zarfının dışında). Ekibimiz inceleyip fiyat verecek.",
  "upload.risk.thin_walls": "İnce duvarlar",
  "upload.risk.not_watertight": "Kapalı hacim değil",
  ...
  "upload.note": "STL/OBJ desteklenir. Model kapalı (watertight) olmalı ve baskı zarfına (220×220×250mm) sığmalı.",
