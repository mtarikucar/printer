...
export async function GET() {
  try {
    ...
    return handleRouteFailure(e, "GET /api/manufacturer/notifications", PARTNER_READ_FAILED_ERROR);
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleRouteFailure(e, "POST /api/manufacturer/notifications", PARTNER_ACTION_FAILED_ERROR);
  }
}
