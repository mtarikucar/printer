...
const tr: Dictionary = {
  ...
  "network.eyebrow": "{n} ilde üretim ağı",
  "network.title": "Türkiye'nin en geniş 3D üretim ağı",
  "network.sub": "Siparişin, sana en yakın atölyeye düşer. Haritada bir ile dokun; o ilde kaç atölye olduğunu ve oraya hangi atölyelerin hizmet verdiğini gör.",
  "network.stat.covered": "{n} ilde hizmet",
  "network.stat.home": "{n} şehirde atölye",
  "network.stat.shipping": "Türkiye'nin her yerine ücretsiz kargo",
  "network.mapLabel": "Türkiye üretim ağı haritası, partner bulunan iller",
  "network.provinceAria": "{il}: {located} atölye, {covering} partner hizmet veriyor",
  "network.tooltip.located": "{n} atölye",
  "network.tooltip.covering": "{n} partner hizmet veriyor",
  "network.selectLabel": "İl seç",
  "network.selectPlaceholder": "İl seç…",
  "network.kind.manufacturer": "Üretici atölyesi",
  "network.kind.painter": "Boyacı atölyesi",
  "network.legend.covered": "Hizmet verilen il",
  "network.hint": "Ayrıntı için bir ile dokun.",
  "network.clear": "Temizle",
  "network.group.located": "Bu ildeki atölyeler",
  "network.group.serving": "Bu ile hizmet verenler",
  "network.empty.located": "Bu ilde henüz atölye yok.",
  "network.empty.serving": "Başka ilden hizmet veren partner yok.",
  "network.provinceCount": "{n} il",
  "network.back": "← Geri",
  "network.coverageTitle": "Hizmet verdiği iller ({n})",
  "network.material.resin": "Reçine",
  "network.material.filament": "Filament",
  ...
  "manufacturer.orders.table.size": "Boyut",
  ...
  "account.orders.table.size": "Boyut",
  ...
  "validator.size.invalid": "Geçersiz boyut seçimi",
  ...
  "landing.fig.ticker": "Türkiye'de üretim · Türkiye'de ücretsiz kargo · PayTR 3D Secure · Baskıdan önce önizleme · Siparişe özel · Reçine & filament ·",
  ...
  "landing.fig.footer.nav.figure": "Kişiye Özel Figür",
  "landing.fig.footer.nav.howItWorks": "Nasıl Çalışır",
  "landing.fig.footer.nav.shop": "Mağaza",
  "landing.fig.footer.nav.products": "Hazır Ürünler",
  "landing.fig.footer.nav.bulk": "Toplu Sipariş",
  "landing.fig.footer.nav.create": "Figürünü Oluştur",
