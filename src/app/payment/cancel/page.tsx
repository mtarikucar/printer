    ...
    <main className="min-h-screen bg-surface-50">
      ...
      <div className="flex items-center justify-center px-4 py-16 sm:py-24">
        <div className="max-w-md mx-auto text-center animate-fade-in-up">
          <div className="w-20 h-20 bg-gradient-to-br from-amber-400 to-orange-400 rounded-full flex items-center justify-center mx-auto shadow-lg animate-bounce-in">
          ...
          <p className="mt-2 text-sm text-gray-500 font-medium animate-fade-in-up delay-200">
