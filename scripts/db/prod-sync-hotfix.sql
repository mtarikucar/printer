...
-- ── foreign keys (best-effort: a pre-existing divergence skips just that FK) ──
DO $$ BEGIN ALTER TABLE "admin_actions" ADD CONSTRAINT "admin_actions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "admin_messages" ADD CONSTRAINT "admin_messages_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "customer_notifications" ADD CONSTRAINT "customer_notifications_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "customer_notifications" ADD CONSTRAINT "customer_notifications_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "disputes" ADD CONSTRAINT "disputes_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "disputes" ADD CONSTRAINT "disputes_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "generation_attempts" ADD CONSTRAINT "generation_attempts_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "gift_card_redemptions" ADD CONSTRAINT "gift_card_redemptions_gift_card_id_gift_cards_id_fk" FOREIGN KEY ("gift_card_id") REFERENCES "public"."gift_cards"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "gift_card_redemptions" ADD CONSTRAINT "gift_card_redemptions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "gift_card_redemptions" ADD CONSTRAINT "gift_card_redemptions_draft_id_order_drafts_id_fk" FOREIGN KEY ("draft_id") REFERENCES "public"."order_drafts"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "gift_card_redemptions" ADD CONSTRAINT "gift_card_redemptions_redeemed_by_user_id_users_id_fk" FOREIGN KEY ("redeemed_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "gift_cards" ADD CONSTRAINT "gift_cards_buyer_user_id_users_id_fk" FOREIGN KEY ("buyer_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "invoices" ADD CONSTRAINT "invoices_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_actions" ADD CONSTRAINT "manufacturer_actions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_actions" ADD CONSTRAINT "manufacturer_actions_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_assignment_evaluations" ADD CONSTRAINT "manufacturer_assignment_evaluations_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_assignment_evaluations" ADD CONSTRAINT "manufacturer_assignment_evaluations_v1_winner_id_manufacturers_id_fk" FOREIGN KEY ("v1_winner_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_assignment_evaluations" ADD CONSTRAINT "manufacturer_assignment_evaluations_v2_winner_id_manufacturers_id_fk" FOREIGN KEY ("v2_winner_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_documents" ADD CONSTRAINT "manufacturer_documents_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_earnings" ADD CONSTRAINT "manufacturer_earnings_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_earnings" ADD CONSTRAINT "manufacturer_earnings_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_earnings" ADD CONSTRAINT "manufacturer_earnings_payout_id_payouts_id_fk" FOREIGN KEY ("payout_id") REFERENCES "public"."payouts"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_notifications" ADD CONSTRAINT "manufacturer_notifications_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "manufacturer_notifications" ADD CONSTRAINT "manufacturer_notifications_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "mesh_reports" ADD CONSTRAINT "mesh_reports_generation_id_generation_attempts_id_fk" FOREIGN KEY ("generation_id") REFERENCES "public"."generation_attempts"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "messages" ADD CONSTRAINT "messages_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "order_drafts" ADD CONSTRAINT "order_drafts_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "order_drafts" ADD CONSTRAINT "order_drafts_preview_id_previews_id_fk" FOREIGN KEY ("preview_id") REFERENCES "public"."previews"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "order_drafts" ADD CONSTRAINT "order_drafts_gift_card_id_gift_cards_id_fk" FOREIGN KEY ("gift_card_id") REFERENCES "public"."gift_cards"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "order_photos" ADD CONSTRAINT "order_photos_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "orders" ADD CONSTRAINT "orders_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "orders" ADD CONSTRAINT "orders_preview_id_previews_id_fk" FOREIGN KEY ("preview_id") REFERENCES "public"."previews"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "orders" ADD CONSTRAINT "orders_draft_id_order_drafts_id_fk" FOREIGN KEY ("draft_id") REFERENCES "public"."order_drafts"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "orders" ADD CONSTRAINT "orders_gallery_reward_gift_card_id_gift_cards_id_fk" FOREIGN KEY ("gallery_reward_gift_card_id") REFERENCES "public"."gift_cards"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "orders" ADD CONSTRAINT "orders_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "payouts" ADD CONSTRAINT "payouts_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "previews" ADD CONSTRAINT "previews_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "qc_photos" ADD CONSTRAINT "qc_photos_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "qc_photos" ADD CONSTRAINT "qc_photos_manufacturer_id_manufacturers_id_fk" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "qc_reviews" ADD CONSTRAINT "qc_reviews_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;
DO $$ BEGIN ALTER TABLE "user_addresses" ADD CONSTRAINT "user_addresses_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action; EXCEPTION WHEN others THEN RAISE NOTICE 'skip fk (%)', SQLERRM; END $$;

-- ── indexes (best-effort) ──
DO $$ BEGIN CREATE INDEX IF NOT EXISTS "customer_notifications_user_idx" ON "customer_notifications" USING btree ("user_id","created_at"); EXCEPTION WHEN others THEN RAISE NOTICE 'skip idx (%)', SQLERRM; END $$;
DO $$ BEGIN CREATE UNIQUE INDEX IF NOT EXISTS "gift_card_redemptions_draft_id_unique" ON "gift_card_redemptions" USING btree ("draft_id") WHERE "gift_card_redemptions"."draft_id" IS NOT NULL AND "gift_card_redemptions"."refunded_at" IS NULL; EXCEPTION WHEN others THEN RAISE NOTICE 'skip idx (%)', SQLERRM; END $$;
DO $$ BEGIN CREATE UNIQUE INDEX IF NOT EXISTS "mfg_eval_order_version_idx" ON "manufacturer_assignment_evaluations" USING btree ("order_id","weights_version"); EXCEPTION WHEN others THEN RAISE NOTICE 'skip idx (%)', SQLERRM; END $$;
DO $$ BEGIN CREATE INDEX IF NOT EXISTS "messages_order_channel_idx" ON "messages" USING btree ("order_id","channel","created_at"); EXCEPTION WHEN others THEN RAISE NOTICE 'skip idx (%)', SQLERRM; END $$;
DO $$ BEGIN CREATE UNIQUE INDEX IF NOT EXISTS "user_addresses_one_default_idx" ON "user_addresses" USING btree ("user_id") WHERE "user_addresses"."is_default" = true; EXCEPTION WHEN others THEN RAISE NOTICE 'skip idx (%)', SQLERRM; END $$;
