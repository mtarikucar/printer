...
export async function POST(
  ...
  try {
    ...
    return handleRouteFailure(e, "POST /api/manufacturer/products/[id]/files", PARTNER_ACTION_FAILED_ERROR);
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleRouteFailure(e, "DELETE /api/manufacturer/products/[id]/files", PARTNER_ACTION_FAILED_ERROR);
  }
}
