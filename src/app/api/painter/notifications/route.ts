...
export async function GET() {
  try {
    ...
    return handleRouteFailure(e, "GET /api/painter/notifications", PARTNER_READ_FAILED_ERROR);
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleRouteFailure(e, "POST /api/painter/notifications", PARTNER_ACTION_FAILED_ERROR);
  }
}
