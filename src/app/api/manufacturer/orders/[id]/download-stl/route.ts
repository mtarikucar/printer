...
export async function GET(
  ...
  try {
    ...
    if (!fileKeyMatch) {
      return NextResponse.json(
        { error: "STL dosyasının adresi geçersiz. Bu bir sistem hatasıdır; yöneticiye bildirin, dosya yeniden yüklenmeli." },
        { status: 500 }
      );
    }
    ...
    return handleRouteFailure(e, "GET /api/manufacturer/orders/[id]/download-stl", PARTNER_READ_FAILED_ERROR);
  }
}
