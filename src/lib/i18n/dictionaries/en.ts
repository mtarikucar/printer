const en = {
  ...
  "manufacturer.status.sent_to_painter": "Sent to Painter",
  "manufacturer.action.submit_qc": "Submitted QC photos",
  "manufacturer.action.accept": "Accepted the order",
  "manufacturer.action.start_printing": "Started printing",
  "manufacturer.action.finish_printing": "Finished printing",
  "manufacturer.action.send_to_painter": "Sent to painter",
  "manufacturer.action.ship": "Shipped to customer",
  "manufacturer.action.cancel_after_accept": "Manufacturer cancelled the order",
