...
export async function POST(request: NextRequest) {
  try {
    ...
    return handleRouteFailure(e, "POST /api/manufacturer/printer-photo", PARTNER_ACTION_FAILED_ERROR);
  }
}
...
export async function GET() {
  try {
    ...
    return handleRouteFailure(e, "GET /api/manufacturer/printer-photo", PARTNER_READ_FAILED_ERROR);
  }
}
