...
export async function PATCH(
  ...
  try {
    ...
    return handleRouteFailure(e, "PATCH /api/admin/categories/[id]", ADMIN_ACTION_FAILED_ERROR);
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleRouteFailure(e, "DELETE /api/admin/categories/[id]", ADMIN_ACTION_FAILED_ERROR);
  }
}
