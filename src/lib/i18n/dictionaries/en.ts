const en = {
  ...
  "upload.sub": "Upload your STL or OBJ file — we'll prep it for printing and price it.",
  ...
  "upload.needsQuoteSub": "The geometry isn't suitable for automatic pricing (not a closed volume, or outside the print envelope). Our team will review it and quote you.",
  "upload.risk.thin_walls": "Thin walls",
  "upload.risk.not_watertight": "Not a closed volume",
  ...
  "upload.note": "STL/OBJ supported. The model should be watertight and fit the print envelope (220×220×250mm).",
