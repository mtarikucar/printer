...
export async function GET(
  ...
  try {
    ...
    return handleRouteFailure(e, "GET /api/admin/orders/[id]/messages", ADMIN_READ_FAILED_ERROR);
  }
}
...
export async function POST(
  ...
  try {
    ...
    return handleRouteFailure(e, "POST /api/admin/orders/[id]/messages", ADMIN_ACTION_FAILED_ERROR);
  }
}
